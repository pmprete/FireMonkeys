...
$n_days = 5;
$wind_hdg = array(45, 50, 60, 10, 23);
$wind_int = array(3, 4, 8, 4, 5);
...
foreach($dates as $n => $date){
    ...
    $points2 = array();
    foreach($points as $point){
        $points2[] = newPosByDistanceAndHdg($point, $centroid, $wind_int[$n], $wind_hdg[$n]);
    }
...
function newPosByDistanceAndHdg($coords, $centroid, $d, $angle)
{
    $lat1 = $coords[1];
    $long1 = $coords[0];
    $alt1 = $coords[2];
